...
HUGGINGFACE_REPO = "DARELab/geoquery"
...
class Geoquery(Dataset):
    ...
    **Usage**
    ```python
    from darelabdb.utils_datasets import Geoquery
    ...
    def get_info(self) -> Dict[str, str]:
        ...
        return {
            "name": "Geoquery",
            "description": "A text-to-SQL dataset upon a database with US geographical information.",
    ...
    def _init_data(self):
        """
        Downloads the Geoquery dataset from Huggingface, unzips it, and loads the
        ...
        data_df = pd.read_json(self.dataset_folder + "data/geoquery.json")
        #
    ...
    def get_db_path(self, db_id: str) -> str:
        ...
        return f"{self.dataset_folder}/geoquery/database/{db_id}.sqlite"
