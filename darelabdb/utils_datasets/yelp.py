...
class Yelp(Dataset):
    ...
    **Usage**
    ```python
    from darelabdb.utils_datasets import Yelp
    ...
    def _init_data(self):
        """
        Downloads the Yelp dataset from Huggingface, unzips it, and loads the
        ...
        data_df = pd.read_json(self.dataset_folder + "data/yelp.json")
