...
class Advising(Dataset):
    ...
    **Usage**
    ```python
    from darelabdb.utils_datasets import Advising
    ...
    def get_info(self) -> Dict[str, str]:
        ...
        return {
            "name": "Advising",
            "description": "A text-to-SQL dataset upon a database with course information.",
    ...
    def _init_data(self):
        """
        Downloads the Advising dataset from Huggingface, unzips it, and loads the
        ...
        data_df = pd.read_json(self.dataset_folder + "data/advising.json")
        #
    ...
    def get_db_path(self, db_id: str) -> str:
        ...
        return f"{self.dataset_folder}/advising/database/{db_id}.sqlite"
