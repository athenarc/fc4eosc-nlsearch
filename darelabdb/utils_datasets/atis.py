...
class Atis(Dataset):
    ...
    **Usage**
    ```python
    from darelabdb.utils_datasets import Atis
    ...
    def get_info(self) -> Dict[str, str]:
        ...
        return {
            "name": "Atis",
            "description": "A text-to-SQL dataset upon a database of an air travel information system.",
    ...
    def _init_data(self):
        """
        Downloads the Atis dataset from Huggingface, unzips it, and loads the
        ...
        data_df = pd.read_json(self.dataset_folder + "data/atis.json")
        #
    ...
    def get_db_path(self, db_id: str) -> str:
        ...
        return f"{self.dataset_folder}/atis/database/{db_id}.sqlite"
