...
HUGGINGFACE_REPO = "DARELab/scholar"
...
class Scholar(Dataset):
    ...
    **Usage**
    ```python
    from darelabdb.utils_datasets import Scholar
    ...
    def get_info(self) -> Dict[str, str]:
        ...
        return {
            "name": "Scholar",
            "description": "A text-to-SQL dataset upon an academic database.",
    ...
    def _init_data(self):
        """
        Downloads the Scholar dataset from Huggingface, unzips it, and loads the
        ...
        data_df = pd.read_json(self.dataset_folder + "data/scholar.json")
